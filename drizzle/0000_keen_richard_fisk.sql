...
CREATE UNIQUE INDEX "idx_versus_pair_season" ON "versus_stats" USING btree ("player_a_id","player_b_id","season_id");--> statement-breakpoint
CREATE INDEX "idx_versus_player_a" ON "versus_stats" USING btree ("player_a_id","season_id");--> statement-breakpoint
CREATE INDEX "idx_versus_player_b" ON "versus_stats" USING btree ("player_b_id","season_id");